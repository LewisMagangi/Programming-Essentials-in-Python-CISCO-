...
x = (int(input("Enter an integer input :")))  # Step 1: write a line of code that prompts the user
hat_list[2] = x                     # to replace the middle number with an integer number entered by the user.
